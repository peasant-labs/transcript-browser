/**
 * Steps waterfall: turn the tasks of a session into a proportional duration
 * lane, each task a horizontal segment whose width is its share of total work
 * time and whose offset is the cumulative work before it
